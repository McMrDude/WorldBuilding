        ...
        <>
            {character && (
                <div>
                    ...
                    <div>
                        { editState ? <textarea value={lore} onChange={(e) => changeLore(e.target.value)} placeholder='Write your awsome pogchamp sigma lore you dweeb'></textarea> : <p>{character.lore}</p>}
                    </div>
                    <div>
